...
public class GoodsController {
    ...
    @Autowired
    private Destination queueSolrDeleteDestination;//在索引库中删除记录的消息

    @Autowired
    private Destination topicPageDeleteDestination;//删除商品详细页的消息
    /**
     * 批量删除
     *
     * @param ids
    ...
    @Autowired
    private Destination topicPageDestination;//用于生成商品详细页面的消息
    /**
     * 更新状态
     *
     * @param ids
